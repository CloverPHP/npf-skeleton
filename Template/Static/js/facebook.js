...
Facebook.prototype.logoutUser = function (callback) {
    var me = this;
    me.fb.api('/me/permissions', 'DELETE', function (response) {
...
Facebook.prototype.resetPermit = function (callback) {
    var me = this;
    me.logoutUser(function (success) {
        console.log(success);
        if (success)
            me.requierdPermit(callback);
        else
            me.emit(callback, false);
    });
};
